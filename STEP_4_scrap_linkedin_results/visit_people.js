// ———————————————————————————————————————————————————————————————
// ———————————————————————————————————————————————————————————————
// Title : Visite des personnes en resultats de recherches
// ———————————————————————————————————————————————————————————————
// ***************************************************************
// Description 
// On va visiter le profil des personnes en resultats de recherche
// ***************************************************************
// ———————————————————————————————————————————————————————————————
...
var credentials = {email:"xxxxxxxx@company.com",password:"**********"};
...
function Extract_data_on_page(){
  ...
  casper.repeat(num_result,function(){
  ...
  casper.then(function(){
    ...
    console.log('*******************************');
    // ————————————————————————————————————————————————————————————————————————————————————————
    // A ce niveau on a un tableau avec la liste des profils, on peut donc tous les visiter
    // ————————————————————————————————————————————————————————————————————————————————————————
  ...
  function visitProfil(){
    ...
    casper.repeat(result.length,function(){
      //On verifie bien qu'on a le profil de la personne
